...
/* @var $searchModel common\models\FootericonSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Footericons');
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="">
                            <a href="<?=Url::to(['footericon/create'])?>">
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'urlCreator' => function ($action, \common\models\Footericon $model, $key, $index, $column) {
